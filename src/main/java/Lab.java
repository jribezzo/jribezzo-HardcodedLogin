...
public class Lab {
    ...
    {
        boolean result = (username.equalsIgnoreCase("admin") && password.equalsIgnoreCase("qwerty")) ? true : false;
        boolean result2 = (username.equalsIgnoreCase("user") && password.equalsIgnoreCase("password")) ? true : false;
        if (result)
        {
            return true;
        }
